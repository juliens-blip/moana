...
|----|------|-------------|----------|--------|---------|
| TASK-001 | Design CRM Architecture for Yatco LeadFlow | Claude | HIGH | IN_PROGRESS | 2026-01-16 17:55 |
| TASK-002 | Create API endpoint POST /api/leads/yatco | AMP | HIGH | COMPLETED | 2026-01-16 17:55 |
| TASK-003 | Create Leads table schema (Airtable/Supabase) | AMP | HIGH | COMPLETED | 2026-01-16 17:55 |
| TASK-004 | Create CRM UI components for brokers | AMP | MEDIUM | COMPLETED | 2026-01-16 17:55 |
| TASK-005 | Generate TypeScript types for Yatco Lead | Codex | MEDIUM | COMPLETED | 2026-01-16 17:55 |
| TASK-006 | Generate Zod validation schemas for leads | Codex | MEDIUM | COMPLETED | 2026-01-16 17:55 |
...
- **Implementation**: `scripts/leads-schema.sql`
- **Date**: 2026-01-16 17:55
...
| 2026-02-04 | AMP | TASK-003 | 10 min | COMPLETED | Schema validé dans scripts/leads-schema.sql. Mise à jour CLAUDE.md. |
...
- Brokers: si `JMO` n'apparaît pas dans `/api/brokers` alors qu'il existe en base, vérifier l'environnement Supabase utilisé par Vercel. Cas vu: `JMO` existait par email mais pas par `broker_name` → l'API listait sans JMO. Solution: garantir `broker_name='JMO'` dans la base prod ou inclure la recherche par email.
