...
export async function GET(
  ...
  try {
    ...
    const listing = await getTrackedListing('bateaux_chantier', params.id);
    ...
    console.error('Error in GET /api/bateaux-chantier/[id]:', error);
    return NextResponse.json<ApiResponse>(
...
export async function PUT(
  ...
  try {
    ...
    const existing = await getTrackedListing('bateaux_chantier', params.id);
    ...
    const listing = await updateTrackedListing('bateaux_chantier', params.id, validation.data);
    ...
    console.error('Error in PUT /api/bateaux-chantier/[id]:', error);
    return NextResponse.json<ApiResponse>(
...
export async function DELETE(
  ...
  try {
    ...
    await deleteTrackedListing('bateaux_chantier', params.id);
    ...
    console.error('Error in DELETE /api/bateaux-chantier/[id]:', error);
    return NextResponse.json<ApiResponse>(
