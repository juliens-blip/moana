...
export async function GET(request: NextRequest) {
  try {
    ...
    const listings = await getTrackedListings('bateaux_a_suivre', filters);
    ...
    console.error('Error in GET /api/bateaux-a-suivre:', {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const listing = await createTrackedListing('bateaux_a_suivre', validation.data, session.brokerId);
    ...
    console.error('Error in POST /api/bateaux-a-suivre:', {
      message: error?.message,
      stack: error?.stack,
      error,
    });
