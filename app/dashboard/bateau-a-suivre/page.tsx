...
const BATEAUX_A_SUIVRE = [
  ...
  { nom: 'JPK', annee: 2019 },
  { nom: 'Beneteau Swift Trawler', annee: 2011 },
  { nom: 'Fountain Pajot MY 44', annee: null },
  { nom: 'Wally Wally', annee: 2024 },
  { nom: 'Bluegame 42', annee: null },
  { nom: 'Beneteau Oceanis 40', annee: null }, // (jm)
  { nom: 'Lagoon', annee: 2018 },
  { nom: 'Arcoa Canot 41', annee: 2007 },
...
export default function BateauASuivrePage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/bateaux-a-suivre/${listingToDelete.id}`, {
        method: 'DELETE',
      });
      ...
      console.error('Error deleting tracked listing:', error);
      toast.error('Erreur de connexion');
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between animate-fade-in-up" style={{ animationDelay: '0ms' }}>
        <div className="animate-fade-in" style={{ animationDelay: '100ms' }}>
          <h1 className="text-3xl font-bold text-gray-900">Bateaux à Suivre</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          <p className="text-gray-500 text-lg">Aucun bateau à suivre trouvé</p>
          <p className="text-gray-400 text-sm mt-2">
            {search || localisation
              ? 'Essayez de modifier vos filtres'
              : 'Les bateaux à suivre apparaîtront ici'}
          </p>
        </div>
      ) : (
      ...
      <ListingDetailModal
        ...
        apiBasePath="/api/bateaux-a-suivre"
      />
