...
export default function BateauChantierPage() {
  ...
  const fetchListings = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/bateaux-chantier?${params.toString()}`);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between animate-fade-in-up" style={{ animationDelay: '0ms' }}>
        ...
        <Link href="/dashboard/bateau-chantier/create" className="animate-fade-in" style={{ animationDelay: '150ms' }}>
          <Button>
